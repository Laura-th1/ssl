...
<head>
    ...
    <title>Generos | Sena Stock</title>
...
<style>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="waves-effect waves-dark active" href="../generos" aria-expanded="false">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Generos</h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="btn-wrapper">
                            <a href="#" class="btn text-white me-0" style="background-color: #39a900; color: #ffffff;" onclick="CrearNueva();"><i class="icon-download"></i> Crear Nuevo Generos</a>
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <script type="text/javascript">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="div_nickname">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-dark bg-white" id="nombre" name="nombre" placeholder="Ingresar Nombre" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                ...
                buttons: {
                    ...
                    guardar: {
                        ...
                        action: function(saveButton) {
                            var nombre_genero = $("#nombre").val();
                            requisitos("POST",
                                "../../../peticiones_json/panel_administrativo/sexos/sexos_json.php",
                                "opcion=AccionInsertar&nombre=" + nombre_genero + "&jsonp=?",
                                function(data) {
                                    if (data["ALERTA"] == 'OK') {
                                        consultas("Sexos");
        ...
        function Editar(id, nombre, estado) {
                    ...
                    buttons: {
                        ...
                        actualizar: {
                            ...
                            action: function(saveButton) {
                                ...
                                requisitos("POST",
                                    "../../../peticiones_json/panel_administrativo/sexos/sexos_json.php",
                                    "opcion=AccionActualizar&id="+id+"&nombre=" + nombre_genero + "&estado="+estado_new+"&jsonp=?",
                                    function(data) {
                                        if (data["ALERTA"] == 'OK') {
                                            consultas("Sexos");
            ...
            function TBSexos(data) {
                tabla_datos_sexos = $("#tablaSexos").dxDataGrid({
